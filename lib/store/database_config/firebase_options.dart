...
class DefaultFirebaseOptions {
  ...
  static FirebaseOptions windows = FirebaseOptions(
    apiKey: dotenv.env['WINDOWS-API-KEY'] as String,
    appId: dotenv.env['WINDOWS-APP-ID'] as String,
    messagingSenderId: dotenv.env['WINDOWS-MESSAGING-SENDER-ID'] as String,
    projectId: dotenv.env['WINDOWS-PROJECT-ID'] as String,
    authDomain: dotenv.env['WINDOWS-AUTH-DOMAIN'] as String,
    storageBucket: dotenv.env['WINDOWS-STORAGE-BUCKET'] as String,
    measurementId: dotenv.env['WINDOWS-MEASUREMENT-ID'] as String,
  );
}
